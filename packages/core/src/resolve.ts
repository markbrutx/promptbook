 ...
 *
 * Loads the prompts folder, then delegates to {@link resolveBook}. Given the
 * same folder contents and input, the returned `text` is byte-for-byte stable.
 *
...
/**
 * Pure resolver over an already-loaded {@link PromptBook}.
 *
